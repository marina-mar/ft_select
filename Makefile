...
$(NAME):
	...
	$(MAKE) -C $(DIRLIB)
	mv $(DIRLIB)libft.a .
	gcc $(FLAGS) $(INCLUDE) -L. -lselect -lft main.c -o $(NAME) -ltermcap

debug: libdebug
	$(MAKE) debug -C $(DIRLIB)
	mv $(DIRLIB)libft.a .
	gcc $(FLAGS) $(INCLUDE) -L. -lselect -lft main.c -o $(NAME) -ltermcap -g

sanitize: libsanitize
	$(MAKE) sanitize -C $(DIRLIB)
	gcc $(FLAGS) $(INCLUDE) -L. -lselect -lft main.c -o $(NAME) -ltermcap -g -fsanitize=address
